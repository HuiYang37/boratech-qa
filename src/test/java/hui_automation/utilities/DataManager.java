...
public class DataManager {
	...
	private hui_automation.api_pojos.Experience experienceAPI;	
	private hui_automation.api_pojos.Education educationAPI;
	...
	public hui_automation.api_pojos.Education getEducationAPI() {
		assertNotNull(educationAPI, "API - no education created.");
		return educationAPI;
	}

	public void setEducationAPI(hui_automation.api_pojos.Education educationAPI) {
		this.educationAPI = educationAPI;
	}

	public hui_automation.api_pojos.Experience getExperienceAPI() {
		assertNotNull(experienceAPI, "API - no experience created.");
		return experienceAPI;
	}

	public void setExperienceAPI(hui_automation.api_pojos.Experience experienceAPI) {
